...
/**
* Unit tests for local_questionnaire_reminder_get_courses_ended_7_days_ago_with_visible_questionnaire
*
...
class local_questionnaire_reminder_get_courses_ended_7_days_ago_with_visible_questionnaire_test extends advanced_testcase {
    ...
    */
    ...
    public function test_course_with_visible_questionnaire_and_enddate_7_days_ago_is_returned() {
        ob_start();
        $course = $this->create_test_course(strtotime('-7 days'));
    ...
    public function test_course_with_enddate_today_is_not_returned() {
        ob_start();
    ...
    public function test_course_without_questionnaire_is_not_returned() {
        ob_start();
        $course = $this->create_test_course(strtotime('-7 days'), 1, 1, false);
    ...
    public function test_course_with_hidden_questionnaire_is_not_returned() {
        ob_start();
        $course = $this->create_test_course(strtotime('-7 days'), 1, 1, true, 0);
    ...
    public function test_course_with_lingua_zero_is_not_returned() {
        ob_start();
        $course = $this->create_test_course(strtotime('-7 days'), 1, 0);
    ...
    public function test_course_not_visible_is_not_returned() {
        ob_start();
        $course = $this->create_test_course(strtotime('-7 days'), 0);
    ...
    public function test_multiple_valid_courses_are_returned() {
        ob_start();
        $course1 = $this->create_test_course(strtotime('-7 days'));
        $course2 = $this->create_test_course(strtotime('-7 days'));
