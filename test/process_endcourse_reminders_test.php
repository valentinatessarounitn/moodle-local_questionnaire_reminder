...
/**
* Unit tests for process_endcourse_reminders().
*
...
final class process_endcourse_reminders_test extends advanced_testcase {
    ...
    public function test_course_ending_today_is_selected(): void {
        global $DB;
        ...
        $now = time();
        $start = $now - (5 * DAYSECS);
        $end = strtotime(date('Y-m-d 23:59:59')); // oggi
    ...
    public function test_process_endcourse_reminders_executes_without_error(): void {
        ob_start();
