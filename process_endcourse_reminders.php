...
function process_endcourse_reminders(): void {
    ...
    foreach ($courses as $course) {
        ...
        log::trace("📅 Invio sollecito di fine corso per {$course->fullname} a " . count($incompleteusers) . " utenti");
        ...
        log::trace("✔️ Completato l'invio del sollecito di fine corso per il corso {$course->fullname} (ID {$course->id})");
    }
